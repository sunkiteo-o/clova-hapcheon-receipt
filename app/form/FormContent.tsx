...
export default function FormContent({ region }: { region: Region }) {
  return (
    <Suspense fallback={<div className="min-h-screen bg-tint-50" />}>
      <FormInner region={region} />
    </Suspense>
  );
}
